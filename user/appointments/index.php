							...
							<td align="center">
								...
								<div class="dropdown-menu" role="menu">
									...
									<?php if ($_SESSION['userdata']['role_id'] == 2 || $_SESSION['userdata']['role_id'] == 3) { ?>
										...
										<div class="divider"></div>
									<?php } ?>
									<a class="dropdown-item delete_data" href="javascript:void(0)" data-id="<?php echo $row['aid'] ?>"> Delete</a>
								</div>
							</td>
						</tr>
					<?php endwhile; ?>
...
<script>
	...
	$(document).ready(function() {
		$('.view_data').click(function() {
			uni_modal("Booking Details", "appointments/view_details.php?id=" + $(this).attr('data-id'))
		})
		$('#create_new').click(function() {
			uni_modal("Booking Form", "appointments/manage_appointment.php", 'mid-large')
		})
		$('.edit_data').click(function() {
			uni_modal("Edit Booking Details", "appointments/manage_appointment.php?id=" + $(this).attr('data-id'), 'mid-large')
		})
		$('.delete_data').click(function() {
			result = confirm('Are you sure you wish to delete this booking? Changes can not be reversed.')
			if (result) {
				start_loader();
				$.ajax({
