        ...
        <div class="container-fluid">
			...
			<table class="table table-bordered table-stripped" id="indi-list">
				...
				<tbody>
					<?php
					$i = 1;
						$qry = $conn->query("SELECT p.*,a.date_sched,a.status,a.id as aid from `clients` p inner join `appointments` a on p.id = a.client_id  order by unix_timestamp(a.date_sched) desc ");
